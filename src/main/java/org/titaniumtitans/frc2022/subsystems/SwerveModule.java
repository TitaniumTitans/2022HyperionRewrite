...
public class SwerveModule {
  ...
  public SwerveModuleState getState() {
    return new SwerveModuleState(m_driveMotor.getSelectedSensorVelocity() * ModuleConstants.kDriveEncoderDistancePerPulse * 10, new Rotation2d(Units.degreesToRadians(m_turningEncoder.getAbsolutePosition())));
  }
